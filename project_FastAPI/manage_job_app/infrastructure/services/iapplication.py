...
class IApplicationService(ABC):
    ...
    @abstractmethod
    async def get_by_user(self, user_id: int) -> Iterable[Application]:
    ...
    @abstractmethod
    async def add_application(self, data: ApplicationIn) -> Application | None:
    ...
    @abstractmethod
    async def update_application(self, application_id: int, data: ApplicationIn) -> Application | None:

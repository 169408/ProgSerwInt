...
class ApplicationRepository(IApplicationRepository):
    ...
    async def get_all_applications(self) -> Iterable[Any]:
        ...
        # user_author_alias = alias(employer_table, name="users_author")
        # user_applicant_alias = alias(employee_table, name="users_applicant")

        query = (
            select(application_table, offer_table, employer_table, employee_table)
            .select_from(
                join(
                    application_table,
                    offer_table,

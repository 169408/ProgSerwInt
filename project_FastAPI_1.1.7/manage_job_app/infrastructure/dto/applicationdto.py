...
class ApplicationDTO(BaseModel):
    ...
    def from_record(cls, record: Record) -> "ApplicationDTO":
        ...
        city_data_present_1 = record_dict.get("id_5") is not None and record_dict.get("name_3") is not None
        city_data_present_2 = record_dict.get("id_6") is not None and record_dict.get("name_4") is not None
